...
const supportedLanguages = ["Spanish", "French", "German", "Japanese", "Mandarin Chinese", "Italian", "Portuguese"];

export function AnalysisDisplay({ analysis, onExplainClause, onLanguageChange, onDownload, isTranslating }: AnalysisDisplayProps) {
  return (
